...
export default {
  ...
  data () {
    return {
      ...
      sdkKey: "ZWsGLbevwzZA2hgVk6ljRBPaXim5Pa4cpgsd",
      leaveUrl: 'https://azgr.github.io/',
      meetingNumber: "2796149035",
      passWord: "agr",
      role: 1,
      signatureEndpoint: "https://signature-developing-applic.herokuapp.com/",
      userEmail: "",
      userName: "DKR",
